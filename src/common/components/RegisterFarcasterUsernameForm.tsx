...
const RegisterFarcasterUsernameForm = ({
  ...
  const renderForm = () => (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(registerFarcasterUsername)} className="space-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This will be your public username. It can be your real name or a pseudonym.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This will be your public bio / account description.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <div className="flex flex-col space-y-2">
          ...
          {chainId !== mainnet.id && (
            <Button type="button" variant="default" onClick={() => switchChainAsync({ chainId: mainnet.id })}>
              Switch to mainnet
            </Button>
          )}
        </div>
